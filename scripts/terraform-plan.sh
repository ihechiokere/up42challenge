#!/bin/bash
# Initialize and plan s3www infrastructure using Terraform
...
echo "=== UP42 Challenge - Terraform Plan ==="
...
echo "Review the plan above, if satisfied, run: ./scripts/terraform-apply.sh"